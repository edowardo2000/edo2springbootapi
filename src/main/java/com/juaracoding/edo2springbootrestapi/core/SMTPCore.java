package com.juaracoding.edo2springbootrestapi.core;


import com.juaracoding.edo2springbootrestapi.configuration.SMTPConfiguration;
...
public class SMTPCore {
    ...
    public boolean sendSimpleMail(String[] strMailTo, String strSubject, String strContentMessage, String strLayer) throws Exception {
        ...
        try {
            ...
            session = Session.getInstance(execProp,
                    new javax.mail.Authenticator() {
                        protected PasswordAuthentication getPasswordAuthentication() {
                            return new PasswordAuthentication(SMTPConfiguration.getEmailUserName(), SMTPConfiguration.getEmailPassword());
                        }
                    });
            ...
            LoggingFile.exceptionStringz(strException,e, OtherConfiguration.getFlagLoging());
            return false;
        }
